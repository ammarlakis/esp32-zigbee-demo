...
char modelid[] = {13, 'G', 'H', 'O', 'U', 'S', 'N', '1', '.', 'L', 'i', 'g', 'h', 't'};
char manufname[] = {9, 'A', 'm', 'm', 'a', 'r', 'L', 'a', 'k', 'i'};
...
static void esp_zb_task(void *pvParameters)
{
    ...
    esp_zb_zcl_attr_t *attr = esp_zb_zcl_get_attribute(HA_ESP_LIGHT_ENDPOINT, ESP_ZB_ZCL_CLUSTER_ID_BASIC, ESP_ZB_ZCL_CLUSTER_SERVER_ROLE, ESP_ZB_ZCL_ATTR_BASIC_MANUFACTURER_NAME_ID);
    if (attr) {
        ESP_LOGI(TAG, "type(%d), value: %s\n", attr->type, (uint8_t *)attr->data_p);
    }
